...
public class BillingClientLifecycle implements LifecycleObserver, PurchasesUpdatedListener,
    ...
    public SingleLiveEvent onBillingSetup = new SingleLiveEvent();
    ...
    public void create() {
        ...
        Log.d(TAG, "BillingClient: Start connection..." + billingClient.isReady());
    ...
    public void onBillingSetupFinished(BillingResult billingResult) {
        ...
        if (responseCode == BillingClient.BillingResponseCode.OK) {
            Log.d(TAG, "onBillingSetupFinished: " + "BillingResponseCode.OK");
    ...
    public void onPurchasesUpdated(BillingResult billingResult, List<Purchase> purchases) {
        ...
        // PHUC TODO: send SOCKET play store response to user's purchase:
        String logPayment = "2. playstore response to user's list purcharse: billingResult code:" + responseCode + "|| billingResult debug msg:" + debugMessage;
...
//                " unacknowledged=" + ack_no);
    ...
    public void querySkuDetails(List<String> skus) {
        ...
        skus.add(BillingConstants.TEST_PURCHASED);
        skus.add(BillingConstants.TEST_CANCELED);
        skus.add(BillingConstants.TEST_REFUNDED);
        skus.add(BillingConstants.TEST_UNAVAILABLE);
    ...
    public int launchBillingFlow(Activity activity, BillingFlowParams params) {
        ...
        // PHUC TODO: send SOCKET payment start buy point:
        String logPayment = "1. user request purchase SKU:" + sku + "  --- responseCode:" + responseCode + "|| debugMessage:" + debugMessage;
        SocketClient.getInstance().sendClientLogs(Config.SLUG_LOG_SOCKET, logPayment);
        return responseCode;
    }
    ...
    public void handlePurchase(final Purchase purchase) {
        ...
        ConsumeResponseListener listener = new ConsumeResponseListener() {
            ...
            public void onConsumeResponse(BillingResult billingResult, String purchaseToken) {
                // PHUC TODO: send SOCKET consume purchase:
                String logPayment = "5. END consume purchase: SKU:" + purchase.getSku() + "|| orderID:" + purchase.getOrderId() + "|| billingResult code:" + billingResult.getResponseCode() + "|| billingResult debug msg:" + billingResult.getDebugMessage();
                SocketClient.getInstance().sendClientLogs(Config.SLUG_LOG_SOCKET, logPayment);

                if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK) {
                    Point pointPackage = PointStore.getInstance().getPointPackage(purchase.getSku());
                    int amount = 0;
                    if (pointPackage != null) amount = pointPackage.getAmount();

                    AdjustEvent adjustEvent = new AdjustEvent(Constants.ADJUST_EVENT_PAYMENT);
                    adjustEvent.setRevenue(amount, "JPY");
                    Adjust.trackEvent(adjustEvent);

                    //Log.e(TAG, "ConsumeAsync::: OK");
                }
            }
        };
